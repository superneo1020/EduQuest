...
import { Calculator, Brain, Star, Zap } from 'lucide-react-native';
        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>Pick a game and become a Math Superstar! ?</Text>
                        ...
                        >
                            ...
                            <View style={styles.cardFooter}>
                                ...
                                <View style={styles.pointsBadge}>
                                    ...
                                    <Text style={styles.pointsText}>+{index === 0 ? '10' : '20'} pts</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                    ))}
