// app/games/components/Writing.tsx
    ...
    React.useEffect(() => {
        const checkConnection = async () => {
            try {
                ...
                const isConnected = await writingAIService.testConnection();
    ...
    const renderConnectionStatus = () => {
        ...
        switch (connectionStatus) {
            case 'connected':
                ...
                break;
            case 'mock':
                statusText = 'Using Mock Analysis';
                statusColor = '#FF9800';
                break;
            case 'checking':
                statusText = 'Checking AI Connection...';
                statusColor = '#2196F3';
                break;
            default:
                statusText = 'AI Disconnected';
                statusColor = '#F44336';
        }
        ...
        >
            ...
            >
                ...
                <View style={styles.header}>
                    <View>
                        <Text style={styles.title}>📝 Scene Writing</Text>
                        <Text style={styles.subtitle}>Describe what you see in 30 words</Text>
                    </View>
                ...
                <View style={styles.promptContainer}>
                    <View style={styles.promptHeader}>
                        <Ionicons name="megaphone-outline" size={20} color="#2196F3" />
                ...
                <View style={styles.writingContainer}>
                    ...
                    <TextInput
                        ...
                        multiline
                        numberOfLines={6}
                        placeholder="Start writing your description here... Try to use descriptive words!"
                        ...
                        {isAnalyzing ? (
                            ...
                            <>
                                ...
                                <Text style={styles.analyzeButtonText}>
                                    {connectionStatus === 'connected' ? 'AI Analysis' : 'Mock Analysis'}
                                </Text>
                            </>
                        )}
                    </TouchableOpacity>
                ...
                <View style={styles.tipsContainer}>
                    ...
                    <Text style={styles.tipsText}>
                        Tip: Write in complete sentences and use descriptive words to make your writing interesting!
                    </Text>
                </View>
            </ScrollView>
